...
func Compose(addresses []models.SendingAddress, fromID, to, subject, inReplyTo, references string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, addr := range addresses {
			...
			templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.JoinStringErrs(addr.ID.String())
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/compose.templ`, Line: 81, Col: 42}
			}
